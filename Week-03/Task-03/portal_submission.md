...
*(Copy and paste the lines below into the "Deliverable links" box on the portal)*

```text
https://github.com/muhammadabdullah-devpk/flyrank-ml-internship/blob/main/Week-03/Task-03/curating_images_track_thread.md
https://github.com/muhammadabdullah-devpk/flyrank-ml-internship/tree/main/Week-03/Task-03
```

---

### Field 2: Notes
*(Copy and paste the text below into the "Notes" context box on the portal)*
...
4. Ruthless Curation & Rejection Notes (Graded Discernment):
   ...
   - Rejected Candidate 02 (Cyberpunk Glowing Robot Head): Binned for sci-fi cliché, false representation of practical NLP engineering, and harsh cyan glow breaking the color palette.

All Pass/Revise criteria have been strictly satisfied and documented in curating_images_track_thread.md.
```

---

### Field 3: Files to Upload
*(If uploading files to the portal submission card, drag and drop the following files from your local workspace folder `d:\FlyRank\Week-03\Task-03`)*

- `curating_images_track_thread.md`
- `README.md`
- `images/profile_headshot_real.png`
- `images/case1_content_decay_real_capture.png`
- `images/case2_bert_classifier_real_capture.png`
- `images/case3_rasa_chatbot_real_capture.png`
- `images/hero_texture_ai_keeper.png`
- `images/icon_set_ai_keeper.png`
- `images/rejected_ai_slop_1_glass_brain.png`
- `images/rejected_ai_slop_2_glowing_robot.png`
